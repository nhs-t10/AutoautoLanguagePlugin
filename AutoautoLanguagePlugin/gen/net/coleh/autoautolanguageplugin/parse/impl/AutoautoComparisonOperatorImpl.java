...
public class AutoautoComparisonOperatorImpl extends ASTWrapperPsiElement implements AutoautoComparisonOperator {

  public AutoautoComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
