...
public class AutoautoMultiStatementImpl extends ASTWrapperPsiElement implements AutoautoMultiStatement {

  public AutoautoMultiStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AutoautoVisitor visitor) {
    visitor.visitMultiStatement(this);
  }
