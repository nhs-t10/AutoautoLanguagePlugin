...
public class AutoautoModuloImpl extends ASTWrapperPsiElement implements AutoautoModulo {

  public AutoautoModuloImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AutoautoBaseExpression> getBaseExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AutoautoBaseExpression.class);
  }
