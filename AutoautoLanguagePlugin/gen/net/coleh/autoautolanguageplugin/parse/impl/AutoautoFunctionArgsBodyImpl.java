...
public class AutoautoFunctionArgsBodyImpl extends ASTWrapperPsiElement implements AutoautoFunctionArgsBody {

  public AutoautoFunctionArgsBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AutoautoVisitor visitor) {
    visitor.visitFunctionArgsBody(this);
  }
