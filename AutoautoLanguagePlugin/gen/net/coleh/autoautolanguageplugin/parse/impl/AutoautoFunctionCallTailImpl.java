...
public class AutoautoFunctionCallTailImpl extends ASTWrapperPsiElement implements AutoautoFunctionCallTail {

  public AutoautoFunctionCallTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AutoautoVisitor visitor) {
    visitor.visitFunctionCallTail(this);
  }
