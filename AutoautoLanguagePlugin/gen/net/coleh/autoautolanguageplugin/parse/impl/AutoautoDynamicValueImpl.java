...
public class AutoautoDynamicValueImpl extends ASTWrapperPsiElement implements AutoautoDynamicValue {

  public AutoautoDynamicValueImpl(@NotNull ASTNode node) {
    super(node);
  }
