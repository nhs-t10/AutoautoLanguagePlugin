...
public class AutoautoArrayElementGetTailImpl extends ASTWrapperPsiElement implements AutoautoArrayElementGetTail {

  public AutoautoArrayElementGetTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AutoautoVisitor visitor) {
    visitor.visitArrayElementGetTail(this);
  }
