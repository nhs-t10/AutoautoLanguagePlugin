...
public class AutoautoAtomImpl extends ASTWrapperPsiElement implements AutoautoAtom {

  public AutoautoAtomImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AutoautoFunctionExpression getFunctionExpression() {
    return findChildByClass(AutoautoFunctionExpression.class);
  }
