...
public interface AutoautoTypes {
  ...
  IElementType ARRAY_ELEMENT_GET_TAIL = new AutoautoElementType("ARRAY_ELEMENT_GET_TAIL");
  IElementType ARRAY_LITERAL = new AutoautoElementType("ARRAY_LITERAL");
  IElementType ATOM = new AutoautoElementType("ATOM");
  ...
  IElementType FUNCTION_ARGS_BODY = new AutoautoElementType("FUNCTION_ARGS_BODY");
  IElementType FUNCTION_CALL_STATEMENT = new AutoautoElementType("FUNCTION_CALL_STATEMENT");
  IElementType FUNCTION_CALL_TAIL = new AutoautoElementType("FUNCTION_CALL_TAIL");
  IElementType FUNCTION_EXPRESSION = new AutoautoElementType("FUNCTION_EXPRESSION");
  ...
  IElementType SETTABLE_TAIL = new AutoautoElementType("SETTABLE_TAIL");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == ARRAY_ELEMENT_GET_TAIL) {
        return new AutoautoArrayElementGetTailImpl(node);
      }
      else if (type == ARRAY_LITERAL) {
        return new AutoautoArrayLiteralImpl(node);
      }
      else if (type == ATOM) {
        return new AutoautoAtomImpl(node);
      }
      ...
      else if (type == FUNCTION_ARGS_BODY) {
        return new AutoautoFunctionArgsBodyImpl(node);
      }
      else if (type == FUNCTION_CALL_STATEMENT) {
        return new AutoautoFunctionCallStatementImpl(node);
      }
      else if (type == FUNCTION_CALL_TAIL) {
        return new AutoautoFunctionCallTailImpl(node);
      }
      else if (type == FUNCTION_EXPRESSION) {
        return new AutoautoFunctionExpressionImpl(node);
      }
      ...
      else if (type == PROPERTY_GET_TAIL) {
        return new AutoautoPropertyGetTailImpl(node);
      }
      else if (type == RETURN_STATEMENT) {
        return new AutoautoReturnStatementImpl(node);
      }
      else if (type == SETTABLE_TAIL) {
        return new AutoautoSettableTailImpl(node);
      }
